...
/*   Updated: 2023/10/25 21:54:54 by lhasmi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//fill the map with the map file, units are characters, space is allowed and is a valid part of the map.
...
bool check_map_characters(t_map map_i)
{
	...
	while (i < map_i.height)
	{
		...
		while (j < map_i.width)
		{
			if (map_i.tiles[i][j] != '0' && map_i.tiles[i][j] != '1' && map_i.tiles[i][j] != 'N' && map_i.tiles[i][j] != 'S' && map_i.tiles[i][j] != 'E' && map_i.tiles[i][j] != 'W')
				return (false);
			j++;
		}
		i++;
